...
function Footer() {
  return (
  <div className="bg-white dark:bg-gray-900 min-h-[60vh]">
    ...
    <div className="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <a href="https://flowbite.com/">Free-Fund</a>. All Rights Reserved.
        </span>
